package moe.leer.markdowneditor.utils;
 ...
 * 1.沉浸式全屏模式
 * 2.状态栏着色模式
 * from https://github.com/H07000223/FlycoSystemBar/blob/master/FlycoSystemBar_Lib/src/main/java/com/flyco/systembar/SystemBarHelper.java
 */
public class SystemBarUtils {
    ...
    public static void forceFitsSystemWindows(Window window) {
        forceFitsSystemWindows(window.getDecorView().findViewById(Window.ID_ANDROID_CONTENT));
    }
