...
import moe.leer.markdowneditor.adapter.FileListAdapter;
import moe.leer.markdowneditor.adapter.OnItemClickLitener;
import moe.leer.markdowneditor.base.BaseApplication;
import moe.leer.markdowneditor.base.BaseRefreshFragment;
import moe.leer.markdowneditor.engine.ActionModeCallback;
import moe.leer.markdowneditor.entity.FileBean;
import moe.leer.markdowneditor.event.RxEvent;
import moe.leer.markdowneditor.presenter.FolderManagerPresenter;
import moe.leer.markdowneditor.presenter.IFolderManagerView;
import moe.leer.markdowneditor.utils.Check;
import moe.leer.markdowneditor.utils.ViewUtils;
import moe.leer.markdowneditor.widget.TabView;
...
//        mAdapter.notifyDataSetChanged();
  ...
  private void initSearchView(Menu menu) {
    ...
    AppCompatAutoCompleteTextView editText = searchView.findViewById(android.support.v7.appcompat.R.id.search_src_text);
...
//        ViewUtils.startActivity(intent, getActivity(), v, EditorActivity.SHARED_ELEMENT_COLOR_NAME);
  ...
  public void createFolder() {
    ...
    TextInputLayout textInputLayout = rootView.findViewById(R.id.inputHint);
    EditText text = rootView.findViewById(R.id.text);
