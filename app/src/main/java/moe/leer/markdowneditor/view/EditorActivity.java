...
import moe.leer.markdowneditor.base.BaseApplication;
import moe.leer.markdowneditor.base.BaseToolbarActivity;
import moe.leer.markdowneditor.event.RxEvent;
import moe.leer.markdowneditor.event.RxEventBus;
import moe.leer.markdowneditor.lib.ExpandableLinearLayout;
import moe.leer.markdowneditor.presenter.IEditorActivityView;
import moe.leer.markdowneditor.utils.Check;
import moe.leer.markdowneditor.utils.FileUtils;
import moe.leer.markdowneditor.utils.SystemBarUtils;
import moe.leer.markdowneditor.utils.Toast;
import moe.leer.markdowneditor.widget.TabIconView;
...
//        getAppBar().addView(mExpandLayout);
  ...
  private void initTab() {
    mTabIconView = findViewById(R.id.tabIconView);
...
//                    ContentResolver cr = this.getContentResolver();
  ...
  private void insertTable() {
    ...
    TextInputLayout rowNumberHint = rootView.findViewById(R.id.rowNumberHint);
    TextInputLayout columnNumberHint = rootView.findViewById(R.id.columnNumberHint);
    EditText rowNumber = rootView.findViewById(R.id.rowNumber);
    EditText columnNumber = rootView.findViewById(R.id.columnNumber);
  ...
  private void insertLink() {
    ...
    TextInputLayout titleHint = rootView.findViewById(R.id.inputNameHint);
    TextInputLayout linkHint = rootView.findViewById(R.id.inputHint);
    EditText title = rootView.findViewById(R.id.name);
    EditText link = rootView.findViewById(R.id.text);
